...
Public Class Form7
    ...
    Sub load()
        Dim query As String = "SELECT SUM(pprice) FROM tbl_product;"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim Header As New Paragraph("Product Information (Sum of Price)", New Font(Font.Name = "Tahoma", 20, Font.Bold))
