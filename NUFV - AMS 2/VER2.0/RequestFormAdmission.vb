...
Public Class RequestFormAdmission
    ...
    Private Sub lnamerequest()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT lastname FROM accountcredentials WHERE usertype = 'Admission'"
    ...
    Private Sub Btnadd1_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd2_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd3_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd4_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd5_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd6_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd7_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd8_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd9_Click_1(sender As Object, e As EventArgs)
    ...
    Public Sub EmailSent()
        ...
        Dim email_body As String = "You got a request form from Department Admission, Please Check your Dashboard to see latest request"
    ...
    Public Sub EmailSentRequestorAdmission()
        Dim email_add As String = "kylehora2023@myyahoo.com"
        Dim email_pass As String = "afdsznkeesgndcsa"
        Dim email_receiver As String = "horakm@students.nu-fairview.edu.ph"
    ...
    Private Sub InsertData()
        ...
        Using connection As New MySqlConnection(str)
            ...
            Using command As New MySqlCommand("", connection)
                ...
                EmailSentRequestorAdmission()
                EmailSent()
                SubmittedFormAdmission.Show()
                Dropdown2.Hide()
                Dropdown3.Hide()
                Dropdown4.Hide()
                Dropdown5.Hide()
    ...
    Private Sub totalamount_TextChanged1(sender As Object, e As EventArgs) Handles amount1.TextChanged, amount2.TextChanged, amount3.TextChanged, amount4.TextChanged, amount5.TextChanged,
    ...
    Private Sub pcbmenuicon_Click_3(sender As Object, e As EventArgs)
        PanelMenu.Hide()
    End Sub
    ...
    Private Sub totalamount_TextChanged(sender As Object, e As EventArgs) Handles amount1.TextChanged, amount2.TextChanged, amount3.TextChanged, amount4.TextChanged, amount5.TextChanged,
        ...
        If Double.TryParse(amount1.Text, value1) AndAlso
            ...
            Dim totalValue As Double = value1 + value2 + value3 + value4 + value5 + value6 + value7 + value8 + value9 + value10 + value11
            Label40.Text = totalValue.ToString()
        End If
    End Sub
    ...
    Private Sub pcbmenuicon_Click_4(sender As Object, e As EventArgs) Handles pcbmenuicon.Click
        PanelMenu.Hide()
    End Sub
    ...
    Private Sub btnminus10_Click1(sender As Object, e As EventArgs) Handles btnminus10.Click
        Btnadd10.Visible = False
    ...
    Private Sub btnminus9_Click1(sender As Object, e As EventArgs) Handles btnminus9.Click
        Btnadd9.Visible = False
