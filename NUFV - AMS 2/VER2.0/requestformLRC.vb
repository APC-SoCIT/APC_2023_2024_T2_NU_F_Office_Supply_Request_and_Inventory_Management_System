...
Public Class requestformLRC
    Dim str As String = "server=localhost; uid=root; pwd=; database=nufvdb"
    Dim con As New MySqlConnection(str)
    Private Sub Btnadd1_Click(sender As Object, e As EventArgs)
    ...
    Private Sub lnamerequest()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT lastname FROM accountcredentials WHERE usertype = 'LRC'"
    ...
    Private Sub Btnadd4_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd5_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd6_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd7_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd8_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Btnadd9_Click(sender As Object, e As EventArgs)
    ...
    Private Sub BtnHome_Click_2(sender As Object, e As EventArgs)
        userdashboardlrc.Show()
        Me.Hide()
    End Sub
    ...
    Public Sub EmailSent()
        ...
        Dim email_body As String = "You got a request form from Department Learning Resource Center (LRC), Please Check your Dashboard to see latest request"
    ...
    Public Sub EmailSentRequestorLRC()
        Dim email_add As String = "kylehora2023@myyahoo.com"
        Dim email_pass As String = "afdsznkeesgndcsa"
        Dim email_receiver As String = "horakm@students.nu-fairview.edu.ph"
    ...
    Private Sub InsertData()
        ...
        Using connection As New MySqlConnection(str)
            ...
            Using command As New MySqlCommand("", connection)
                ...
                EmailSentRequestorLRC()
                EmailSent()
                SubmittedFormLRC.Show()
                Dropdown2.Hide()
                Dropdown3.Hide()
                Dropdown4.Hide()
                Dropdown5.Hide()
    ...
    Private Sub BtnHome_Click_3(sender As Object, e As EventArgs) Handles BtnHome.Click
        userdashboardlrc.Show()
        Me.Hide()
    End Sub
