...
Public Class HeadApproval1_RequestTrackerr
    ' Connection to the database'
    Dim str As String = "server=localhost; uid=root; pwd=; database=nufvdb; convert zero datetime=True"
    Dim con As New MySqlConnection(str)
    Dim i As Integer
    Dim dr As MySqlDataReader
    Private Sub AdminClient_RequestTracker_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Enabled = True
        LoadFirstName()
        firstnamedisplay()
        PanelMenu.Hide()
        ...
        Try
            ...
            Dim cmd As New MySqlCommand("SELECT *
                                     FROM
                                         table_osrequest
                                     WHERE
                                         department IN ('ITSO', 'FSO', 'lab', 'Marketing', 'SDAO', 'LRC', 'FMO', 'Admission','Accounting') AND status1 = 'Approved'
                                     ORDER BY
