...
Public Class requesthistorylrc

    Dim str As String = "server=localhost; uid=root; pwd=; database=nufvdb; convert zero datetime=True"
    Dim con As New MySqlConnection(str)

    Private Sub requesthistorylrc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DataGridView_load()
    End Sub
    ...
    Private Sub txt_search_TextChanged(sender As Object, e As EventArgs) Handles txt_search.TextChanged
        ...
        Else
            ...
            Try
                ...
                Using cmd As New MySqlCommand("SELECT * FROM table_requesthistory WHERE department = 'LRC' AND (requestID LIKE @search OR requestorName LIKE @search OR total LIKE @search OR status2 LIKE @search)", con)
