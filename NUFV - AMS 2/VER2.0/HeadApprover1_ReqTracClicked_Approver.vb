...
Public Class HeadApprover1_ReqTracClicked_Approver
    ...
    Private Sub approvebtn1_Click(sender As Object, e As EventArgs)
    ...
    Private Sub rejectbtn1_Click(sender As Object, e As EventArgs)
    ...
    Private Sub MoveRowsToHistory()
        Try
            ...
            Dim cmd As New MySqlCommand("INSERT INTO table_requesthistory SELECT * FROM table_osrequest WHERE status2 IN ('Rejected')", con)
            cmd.ExecuteNonQuery()

            ' Delete the rows from table_osrequest after moving them to history
            cmd = New MySqlCommand("DELETE FROM table_osrequest WHERE status2 IN ('Rejected')", con)
            cmd.ExecuteNonQuery()
