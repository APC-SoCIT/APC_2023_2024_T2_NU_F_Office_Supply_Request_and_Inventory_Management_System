...
Public Class Faculty_Approver_dashboard
    ...
    'Dim query As String = "SELECT COUNT(*) FROM table_osrequest WHERE usertype = 'Approver_Faculty'"
    'Using cmd As New MySqlCommand(query, connection)
    ...
    'Dim query As String = "SELECT COUNT(*) table_osrequest WHERE status1 = 'Pending' AND usertype = 'Approver_Faculty' "
    ...
    Private Sub PictureBox8_Click(sender As Object, e As EventArgs) Handles PictureBox8.Click
        FFaculty_ReqTrackApprover.Show()
        Me.Hide()
    End Sub
