...
'Accounting Form
Public Class RequestFormAccounting
    ...
    Private Sub firstnamedisplay()
        Using connection As New MySqlConnection(str)
            ...
            Dim query1 As String = "SELECT Firstname FROM accountcredentials WHERE usertype = 'Accounting'"
    ...
    Private Sub lnamerequest()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT lastname FROM accountcredentials WHERE usertype = 'Accounting'"
    ...
    Public Sub EmailSent()
        ...
        Dim email_body As String = "You got a request form from Department Accounting, Please Check your Dashboard to see latest request"
    ...
    Public Sub EmailSentRequestorAccounting()
        Dim email_add As String = "kylehora2023@myyahoo.com"
        Dim email_pass As String = "afdsznkeesgndcsa"
        Dim email_receiver As String = "horakm@students.nu-fairview.edu.ph"
    ...
    Private Sub InsertData()
        ...
        Using connection As New MySqlConnection(str)
            ...
            Using command As New MySqlCommand("", connection)
                ...
                If anyDropdownMissing Or reason.Text = "" Then

                    MessageBox.Show("Missing fields Detected, Please make sure to select and input the missing fields!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
                ...
                EmailSent()
                EmailSentRequestorAccounting()
                SubmittedFormAccounting.Show()
                Dropdown2.Hide()
                Dropdown3.Hide()
                Dropdown4.Hide()
                Dropdown5.Hide()
