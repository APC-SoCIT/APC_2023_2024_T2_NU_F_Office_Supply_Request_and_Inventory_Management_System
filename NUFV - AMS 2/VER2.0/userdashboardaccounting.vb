...
Public Class userdashboardaccounting
    ...
    Private Sub Guna2Panel4_Click(sender As Object, e As EventArgs)
        RequestFormAccounting.Show()
        Me.Hide()
    ...
    Private Sub PictureBox8_Click_1(sender As Object, e As EventArgs) Handles PictureBox8.Click
        Accounting_RequestTracker.DataGridView_load()
        Accounting_RequestTracker.Show()
    ...
    Private Sub Guna2Panel4_Click_1(sender As Object, e As EventArgs) Handles Guna2Panel4.Click
        officesupplyviewer.DataGridView_load()
        officesupplyviewer.Show()
    ...
    Private Sub PictureBox7_Click_2(sender As Object, e As EventArgs) Handles PictureBox7.Click
        requesthistoryaccounting.DataGridView_load()
