...
Public Class RequestFormFaculty
    ...
    Private Sub lnamerequest()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT lastname FROM accountcredentials WHERE usertype = 'Faculty'"
    ...
    Private Sub TextBox11_TextChanged(sender As Object, e As EventArgs) Handles txtbx10.TextChanged
        Dim quantityValue As Integer
        Dim priceValue As Double
    ...
    Private Sub InsertData()
        ...
        Using connection As New MySqlConnection(str)
            ...
            Using command As New MySqlCommand("", connection)
                ...
                ' Loop through each dropdown and add to parameters if it's not blank
                For i As Integer = 1 To 10
                    Dim dropdown As ComboBox = DirectCast(Me.Controls.Find("Dropdown" & i, True).FirstOrDefault(), ComboBox)
                    If dropdown IsNot Nothing AndAlso dropdown.Text <> "" Then
                        Dim quantity As Integer = Integer.Parse(Me.Controls.Find("txtbx" & i, True).FirstOrDefault().Text)
    ...
    Private Sub Button9_Click_1(sender As Object, e As EventArgs) Handles Button9.Click
        If Dropdown1.Text = "" Then
            MsgBox("Please Select atleast 1 item to proceed order!", MsgBoxStyle.Information, "Notification")
        Else
            InsertData()
