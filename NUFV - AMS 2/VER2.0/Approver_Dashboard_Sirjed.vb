...
Public Class Approver_Dashboard_Sirjed
    ...
    Public Sub LoadtotalRequest()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT COUNT(*) FROM table_osrequest WHERE status1 = 'Approved' AND department IN ('ITSO', 'FSO', 'lab', 'Marketing', 'SDAO', 'LRC', 'FMO','Admission','Accounting')"
    ...
    Public Sub Loadtotalpending()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT COUNT(*) FROM table_osrequest WHERE department IN ('ITSO', 'FSO', 'lab', 'Marketing', 'SDAO', 'LRC', 'FMO', 'Admission','Accounting')"
    ...
    Private Sub Approver_Dashboard_Sirjed_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PictureBox8_Click(sender As Object, e As EventArgs) Handles PictureBox8.Click
        ...
        HeadApproval1_RequestTrackerr.DataGridView_load()
        Me.Hide()
    End Sub
