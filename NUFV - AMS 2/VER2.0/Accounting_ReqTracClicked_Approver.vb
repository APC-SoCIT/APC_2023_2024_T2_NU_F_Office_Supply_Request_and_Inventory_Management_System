...
Public Class Accounting_ReqTracClicked_Approver
    ...
    Private Sub Accounting_ReqTracClicked_Approver_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
