...
Public Class ITSO_RequestTrackerApprover
        ...
        Try
            ...
            Dim cmd As New MySqlCommand("SELECT *
                                          FROM
                                            table_osrequest
                                         WHERE
                                            table_osrequest.department = 'ITSO';", con)
    ...
    Private Sub viewreqstat_Click(sender As Object, e As EventArgs) Handles viewreqstat.Click
        If DataGridView1.Rows.GetRowCount(DataGridViewElementStates.Selected) > 0 Then
            ...
            Dim reqTracClickedForm As New ITSO_ReqTracClicked_Approver()
    ...
    Private Sub LoadFirstName()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT firstname FROM accountcredentials WHERE usertype = 'Approver_ITSO'"
    ...
    Private Sub firstnamedisplay()
        Using connection As New MySqlConnection(str)
            ...
            Dim query1 As String = "SELECT Firstname FROM accountcredentials WHERE usertype = 'Approver_ITSO'"
