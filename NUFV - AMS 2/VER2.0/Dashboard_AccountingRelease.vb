...
Public Class Dashboard_AccountingRelease
    ...
    Public Sub LoadtotalRequest()
        Using connection As New MySqlConnection(Str)
            ...
            Dim query As String = "SELECT COUNT(*) FROM table_osrequest WHERE release1 = 'Pending'"
            Using cmd As New MySqlCommand(query, connection)
    ...
    Private Sub PictureBox8_Click(sender As Object, e As EventArgs) Handles PictureBox8.Click
        ApproverRelease_RequestTracker.Show()
        ApproverRelease_RequestTracker.DataGridView_load()
        Me.Hide()
    End Sub

    Private Sub PictureBox7_Click(sender As Object, e As EventArgs) Handles PictureBox7.Click
        Approvalrelease_RequestHistory.Show()
