...
Public Class ApproverRelease_RequestTracker
    ...
    Private Sub viewreqstat_Click(sender As Object, e As EventArgs) Handles viewreqstat.Click
        If DataGridView1.Rows.GetRowCount(DataGridViewElementStates.Selected) > 0 Then
            ...
            Dim reqTracClickedForm As New ApproverRelease_ReqTracClicked()
    ...
    Private Sub LoadFirstName()
        Using connection As New MySqlConnection(str)
            ...
            Dim query As String = "SELECT firstname FROM accountcredentials WHERE usertype = 'Approvalrelease_Accounting'"
    ...
    Private Sub firstnamedisplay()
        Using connection As New MySqlConnection(str)
            ...
            Dim query1 As String = "SELECT Firstname FROM accountcredentials WHERE usertype = 'Approvalrelease_Accounting'"
